...
# --- AEP Objective Function (with fixed directions) ---
def aep_func(x, y):
...
print(f"\nFinal Optimized AEP for Coastal Virginia Wind (GWA): {-cost:.2f} GWh/year")
...
plt.title('AEP Convergence - Coastal Virginia (GWA)')
plt.grid(True)
plt.tight_layout()
plt.show()
print("done")
